...
ActiveRecord::Schema.define(version: 20160618093852) do
  ...
  create_table "refinery_image_slide_translations", force: :cascade do |t|
    t.integer  "refinery_image_slide_id", limit: 4,     null: false
    t.string   "locale",                  limit: 255,   null: false
    t.datetime "created_at",                            null: false
    t.datetime "updated_at",                            null: false
    t.string   "title",                   limit: 255
  ...
  create_table "refinery_image_slides", force: :cascade do |t|
    t.string   "title",              limit: 255
    t.integer  "position",           limit: 4
    t.integer  "image_slideshow_id", limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "image_id",           limit: 4
    t.string   "caption",            limit: 255
